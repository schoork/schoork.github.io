...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.952653cb7f9d959d86e2bf978aefe1c1e19abd22cf64d4ff6dab165a39e2db61.js',function(){input.required=false;search();});}

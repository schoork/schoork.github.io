...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8b50dd87697912f5662b4dc58df354c2abf6e8dd8aa6ba03bee935cf72dab1a3.js',function(){input.required=false;search();});}
